            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                     <ul class="nav" id="side-menu">
                        ...
                        <li><a class="active" >Search Clubs</a></li>
                        <li> <a href="<c:url value="eventList"/>" >Events</a></li>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
	                                    <c:forEach items="${clubEntities}" var="club" >
	                                        <tr class="odd gradeX">
	                                            <td class="center">${club.name}</td>
	                                            <td class="center"><a href="<c:url value="viewClubDetails/${club.id}" />">View Detail</a></td>
	                                        </tr>
	                                     </c:forEach>
                                    </tbody>
                                </table>
